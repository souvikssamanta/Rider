...
setPassword('')
  ...
  return (
   ...
   >Login</button>
   <p className='mt-8 text-xl font-medium'>Join a fleet ?<Link to="/captain-signup" className='text-blue-800'> Register as a captain </Link></p>
   </form>



   <div>
     <Link to="/login" className='bg-orange-400 flex justify-center text-2xl text-white w-full  py-3  mt-40 rounded-xl'>Login as User</Link>
   </div>
