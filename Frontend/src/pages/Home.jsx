...
function Home() {
  return (
    <div>
      <div className='bg-centre bg-cover bg-[url(https://images.unsplash.com/photo-1572239780645-203c467a49b5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDMzfHx8ZW58MHx8fHx8)] h-screen w-full  flex flex-col justify-between'>
